...
triangle_numpy = np.load('meshes/angel_of_grief_triangle.npy', allow_pickle=True).item()
...
bvhNodes_numpy = np.load('meshes/angel_of_grief_nodes.npy', allow_pickle=True).item()
...
transform = make_transform_mat(
    ...
    ti.Vector([278.0, 115.0, 250.0]),  # translation
