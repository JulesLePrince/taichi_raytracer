...
triangle_numpy = np.load('meshes/toilet_triangle.npy', allow_pickle=True).item()
...
bvhNodes_numpy = np.load('meshes/toilet_nodes.npy', allow_pickle=True).item()
...
transform = make_transform_mat(
    ...
    ti.Vector([278.0, 187.0, 190.0]),  # translation
