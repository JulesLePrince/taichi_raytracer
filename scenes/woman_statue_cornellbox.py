...
triangle_numpy = np.load('meshes/woman_statue_triangle.npy', allow_pickle=True).item()
...
bvhNodes_numpy = np.load('meshes/woman_statue_nodes.npy', allow_pickle=True).item()
...
transform = make_transform_mat(
    ...
    ti.Vector([278.0, 205.0, 250.0]),  # translation
    ti.Vector([-90.0, -45.0, 0.0]), # rotation (degrees)
