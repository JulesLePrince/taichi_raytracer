...
triangle_numpy = np.load('meshes/aspasia_triangle.npy', allow_pickle=True).item()
...
bvhNodes_numpy = np.load('meshes/aspasia_nodes.npy', allow_pickle=True).item()
...
transform = make_transform_mat(
    ...
    ti.Vector([0.0, -55.0, 0.0]), # rotation (degrees)
