...
triangle_numpy = np.load('meshes/artemisia_triangle.npy', allow_pickle=True).item()
...
bvhNodes_numpy = np.load('meshes/artemisia_nodes.npy', allow_pickle=True).item()
...
transform = make_transform_mat(
    ...
    ti.Vector([0.0, 183.0, 0.0]), # rotation (degrees)
