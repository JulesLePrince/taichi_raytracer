...
triangle_numpy = np.load('meshes/dragon_noichi_triangle.npy', allow_pickle=True).item()
...
bvhNodes_numpy = np.load('meshes/dragon_noichi_nodes.npy', allow_pickle=True).item()
...
transform = make_transform_mat(
    ...
    ti.Vector([320.0, 210.0, 300.0]),  # translation
    ti.Vector([10.0, 120.0, 10.0]), # rotation (degrees)
