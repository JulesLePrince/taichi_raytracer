...
triangle_numpy = np.load('meshes/easter_triangle.npy', allow_pickle=True).item()
...
bvhNodes_numpy = np.load('meshes/easter_nodes.npy', allow_pickle=True).item()
...
transform = make_transform_mat(
    ...
    ti.Vector([0.0, 190.0, 0.0]), # rotation (degrees)
